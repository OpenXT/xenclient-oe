...
SRC_URI += " \
            ...
            file://0001-Add-thorough-reset-interface-to-pciback-s-sysfs.patch;striplevel=1 \
            file://0002-Backport-PCI-bus-and-slot-reset-functionality.patch;striplevel=1 \
            "
